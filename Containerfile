...
# ui-builder
####################################################################################################
FROM registry.access.redhat.com/ubi10/nodejs-24@sha256:5d7e4b52f0a97f2caf66af4bf9fd1521851a1b05ce045df30df9848474ec01b6 AS ui-builder
...
# back-end-builder
####################################################################################################
FROM registry.access.redhat.com/ubi10/go-toolset@sha256:6abcb6beb3c00960073062ba474cdf924a93f495a8376ec2fb919b4099ffcef6 AS back-end-builder
...
####################################################################################################
FROM registry.access.redhat.com/ubi10/go-toolset@sha256:6abcb6beb3c00960073062ba474cdf924a93f495a8376ec2fb919b4099ffcef6 AS tools
...
# final
####################################################################################################
FROM registry.access.redhat.com/ubi10/ubi-minimal@sha256:d801168f5e8b108586c27a4fd5c92e3c1e8d061084383713926e2ca61b8b6c64 AS final
